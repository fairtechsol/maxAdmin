  ...
  return (
    ...
    <span className="title-14 f-bold p-1" style={{color:name==="Dragon"?"#fc4242":"#ef910f"}}>{name}</span>
     ...
     <div className="w-100 d-flex justify-content-around align-items-center">
       ...
       {(odds?.[0]?.gstatus==="CLOSED" || odds?.[0]?.gstatus==="SUSPENDED") && <div className="dt20bLock"></div>}
          <span className="title-15 f-bold">Even</span>
       </div>
       <div className="dt20OEbox">
       {(odds?.[1]?.gstatus==="CLOSED" || odds?.[1]?.gstatus==="SUSPENDED") && <div className="dt20bLock"></div>}
          <span className="title-15 f-bold">Odd</span>
       </div>
       <div className="dt20OEbox">
       {(odds?.[3]?.gstatus==="CLOSED" || odds?.[3]?.gstatus==="SUSPENDED") && <div className="dt20bLock"></div>}
       <ImClubs color="#000000" size={23}/>
       <GiSpades color="#000000" size={23}/>
       </div>
       <div className="dt20OEbox">
       {(odds?.[2]?.gstatus==="CLOSED" || odds?.[2]?.gstatus==="SUSPENDED") && <div className="dt20bLock"></div>}
     ...
     <div className="w-100 text-end title-12">R-{parseFloat(odds?.[0]?.min)}-{formatNumber(odds?.[0]?.max)}</div>
     ...
     <div className="w-100 d-flex justify-content-around align-items-center mt-2">
       <div className="dt20OEbox">
       {(odds?.[4]?.gstatus==="CLOSED" || odds?.[4]?.gstatus==="SUSPENDED") && <div className="dt20bLock"></div>}
          <span className="title-15 f-bold">{odds?.[4]?.b1}</span>
       </div>
       <div className="dt20OEbox">
       {(odds?.[5]?.gstatus==="CLOSED" || odds?.[5]?.gstatus==="SUSPENDED") && <div className="dt20bLock"></div>}
          <span className="title-15 f-bold">{odds?.[5]?.b1}</span>
       </div>
       <div className="dt20OEbox">
       {(odds?.[7]?.gstatus==="CLOSED" || odds?.[7]?.gstatus==="SUSPENDED") && <div className="dt20bLock"></div>}
       <span className="title-15 f-bold">{odds?.[7]?.b1}</span>
       </div>
       <div className="dt20OEbox">
       {(odds?.[6]?.gstatus==="CLOSED" || odds?.[6]?.gstatus==="SUSPENDED") && <div className="dt20bLock"></div>}
     ...
     <div className="w-100 text-end title-12">R-{parseFloat(odds?.[4]?.min)}-{formatNumber(odds?.[4]?.max)}</div>
