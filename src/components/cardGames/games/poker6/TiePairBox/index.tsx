  ...
  return (
    <div className="w-100 d-flex flex-column mt-2">
     <div className="w-100 text-start" style={{paddingLeft:"0.8rem"}}>
      <h4 className="title-15 f-bold" style={{color:"#ef910f"}}>{title}</h4>
     </div>
        ...
        odds?.map((item:any,index:any)=>{
          return(
            <div className="d-flex flex-column justify-content-center align-items-center" style={{width:"30%"}}>
             <div className="w-100 d-flex flex-row justify-content-between align-items-center position-relative">
                <span className="title-14 f-bold">{title==="Hands"?item?.nation:""}</span>
                <div
          ...
          >
            ...
            >
             ...
             <div className="w-100 d-flex flex-row justify-content-between align-items-center position-relative" style={{height:"44px",border:item?.gstatus==="0"?"4px solid #e9e2e287":"4px solid #cfcfcf",borderRadius:"4px",backgroundColor:"#dddddd"}}>
              {item?.gstatus==="0" && <div className="dt20bLock"></div>}
               {
                title==="Hands"?
                <div className="d-flex flex-row ms-1" style={{gap:"3px",zIndex:"200"}}>
              ...
              <span className="title-14 f-bold ms-1">{item?.nation}</span>
                ...
                <span className="title-14 f-bold me-1">{parseFloat(item?.rate)}</span>
             </div>
