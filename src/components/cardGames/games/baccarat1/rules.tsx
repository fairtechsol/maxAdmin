    ...
    <>
      ...
      <div className="ball-rules-section-container">
        ...
        <ul className="ps-2 pe-2 list-style">
          ...
          <li>
            <b>Big</b> - Bet on the chance that the total number of cards dealt
            between Player and Banker is 5 or 6.
          </li>
          <li>
          ...
          <li>
            <b>Perfect Pair</b> - Bet on the chance that the first two Player or
            Banker cards form a pair of the same suit.
          </li>
          <li>
