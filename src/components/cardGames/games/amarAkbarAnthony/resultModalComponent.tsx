...
const AmarAkbarAnthonyResultComponent: React.FC<Props> = ({ data }: any) => {
  ...
  return (
    <Container className="d-flex align-items-start flex-md-column flex-lg-row" style={{ display: "flex",alignItems:"start"}}>
        ...
        >
          <div className="d-sm-flex flex-sm-row p- title-14 w-100">
            <div
              ...
              style={{ opacity: "0.6",display:"flex",justifyContent:"right" }}
            >
              Winner
            </div>
            <span className="lucky7CommonText-2 title-14 w-50 align-items-left">{pair?.[0]}</span>
          </div>
          ...
          >
            ...
            <span className="lucky7CommonText-2 mr-2 title-14 w-50 align-items-left">{resultCards?.[2]}</span>
          </div>
          ...
          >
            ...
            <span className="lucky7CommonText-2 title-14 w-50">{resultCards?.[1]}</span>
          </div>
          <div
            className="d-sm-flex flex-sm-row w-100 "
            style={{ marginRight: "5px" }}
          >
            ...
            <span className="lucky7CommonText-2 title-14 w-50">{resultCards?.[3]}</span>
          </div>
          <div
            className="d-sm-flex flex-sm-row w-100 "
            style={{ marginRight: "5px" }}
          >
            ...
            <span className="lucky7CommonText-2 title-14 w-50">{resultCards?.[4]}</span>
          </div>
        </div>
      </div>
    </Container>
