          ...
          <div className="card32bNameBox borderBox">
            ...
            <div className="d-flex flex-row">
              ...
              >
                ...
                >
                  R:<span>{parseFloat(player8?.[0]?.min)}</span>-
                  <span>{formatNumber(player8?.[0]?.max)}</span>
                </div>
              </div>
            </div>
          </div>
          <div className="card32bBackRate back-cell-B borderBox">
            {(player8?.[0]?.gstatus === "SUSPENDED" ||
              player8?.[0]?.gstatus === "CLOSED") && (
              <div className="card32bLock"></div>
            )}
            <span className="title-14 f-bold">{player8?.[0]?.b1}</span>
          </div>
          <div className="card32bBackRate back-cell-B borderBox">
            {(player8?.[1]?.gstatus === "SUSPENDED" ||
              player8?.[1]?.gstatus === "CLOSED") && (
              <div className="card32bLock"></div>
            )}
          ...
          <div className="card32bNameBox borderBox">
            ...
            <div className="d-flex flex-row">
              ...
              >
                ...
                >
                  R:<span>{parseFloat(player9?.[0]?.min)}</span>-
                  <span>{formatNumber(player9?.[0]?.max)}</span>
                </div>
              </div>
            </div>
          </div>
          <div className="card32bBackRate back-cell-B borderBox">
            {(player9?.[0]?.gstatus === "SUSPENDED" ||
              player9?.[0]?.gstatus === "CLOSED") && (
              <div className="card32bLock"></div>
            )}
            <span className="title-14 f-bold">{player9?.[0]?.b1}</span>
          </div>
          <div className="card32bBackRate back-cell-B borderBox">
            {(player9?.[1]?.gstatus === "SUSPENDED" ||
              player9?.[1]?.gstatus === "CLOSED") && (
              <div className="card32bLock"></div>
            )}
          ...
          <div className="card32bNameBox borderBox">
            ...
            <div className="d-flex flex-row">
              ...
              >
                ...
                >
                  R:<span>{parseFloat(player10?.[0]?.min)}</span>-
                  <span>{formatNumber(player10?.[0]?.max)}</span>
                </div>
              </div>
            </div>
          </div>
          <div className="card32bBackRate back-cell-B borderBox">
            {(player10?.[0]?.gstatus === "SUSPENDED" ||
              player10?.[0]?.gstatus === "CLOSED") && (
              <div className="card32bLock"></div>
            )}
            <span className="title-14 f-bold">{player10?.[0]?.b1}</span>
          </div>
          <div className="card32bBackRate back-cell-B borderBox">
            {(player10?.[1]?.gstatus === "SUSPENDED" ||
              player10?.[1]?.gstatus === "CLOSED") && (
              <div className="card32bLock"></div>
            )}
          ...
          <div className="card32bNameBox borderBox">
            ...
            <div className="d-flex flex-row" style={{ position: "relative" }}>
              ...
              >
                ...
                >
                  R:<span>{parseFloat(player11?.[0]?.min)}</span>-
                  <span>{formatNumber(player11?.[0]?.max)}</span>
                </div>
              </div>
            </div>
          </div>
          <div className="card32bBackRate back-cell-B borderBox">
            {(player11?.[0]?.gstatus === "SUSPENDED" ||
              player11?.[0]?.gstatus === "CLOSED") && (
              <div className="card32bLock"></div>
            )}
            <span className="title-14 f-bold">{player11?.[0]?.b1}</span>
          </div>
          <div className="card32bBackRate back-cell-B borderBox">
            {(player11?.[1]?.gstatus === "SUSPENDED" ||
              player11?.[1]?.gstatus === "CLOSED") && (
              <div className="card32bLock"></div>
            )}
