    ...
    <div className="ruleTable bg-white">
      ...
      <div className="">
            ...
            return (
              ...
              >
                ...
                <div className="ruleTableList-boxValue">
                  <span className="title-14 text-uppercase">{item?.value}</span>
                </div>
              </li>
            );
          })}
        ...
        <p className="title-14 p-2">
          ...
          bets of bookmaker will be voided if match drawn/tie. Odd/even results
          will be given based on the total score by the end of the respective
          over. In case of wrong rate, bets based on that wrong rate in that
          particular event will be deleted(Rest all will remain valid)
        </p>
      </div>
    </div>
  );
